...
- [terraform-aws-waf](https://github.com/cloudposse/terraform-aws-waf) - Terraform module to create and manage AWS WAF rules for additional application-layer protection
- [aws-wafv2 Component](https://github.com/cloudposse-terraform-components/aws-wafv2) - Cloud Posse component for AWS WAFv2, often used alongside Shield Advanced
...
>
> <a href="https://cpco.io/commercial-support?utm_source=github&utm_medium=readme&utm_campaign=cloudposse-terraform-components/aws-shield&utm_content=commercial_support"><img alt="Request Quote" src="https://img.shields.io/badge/request%20quote-success.svg?style=for-the-badge"/></a>
> <details><summary>📚 <strong>Learn More</strong></summary>
>
> <br/>
>
> Cloud Posse is the leading [**DevOps Accelerator**](https://cpco.io/commercial-support?utm_source=github&utm_medium=readme&utm_campaign=cloudposse-terraform-components/aws-shield&utm_content=commercial_support) for funded startups and enterprises.
>
...
For 🐛 bug reports & feature requests, please use the [issue tracker](https://github.com/cloudposse-terraform-components/aws-shield/issues).
